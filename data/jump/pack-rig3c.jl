using JuMP
function build_model(; nodes = 1:Nnd, bnd_nodes, int_nodes = nodes diff bnd_nodes, fix_nodes, elements, Omega0, n, h, Nnd, i_ref, j_ref, y, u0)
    model = Model()
    @variable(model, 0.6 <= a[0:n] <= 2.0)
